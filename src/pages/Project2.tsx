  ...
  return (
    ...
    >
      ...
      <TextContainer>
        ...
        <Description>
          본 프로젝트는 심심할 때 재미있게 두뇌를 자극하며 즐길 수 있는 어휘
          퀴즈 웹 사이트입니다.
          <br />
          사용자는 약 3500개의 랜덤한 한국어 어휘 퀴즈를 풀며 여가시간을 활용할
          수 있습니다. <br />
          퀴즈는 10개씩 세트로 구성 된 일반 퀴즈와 오답이 나올 때 까지 무한으로
          즐길 수 있는 챌린지 퀴즈 두가지 테마가 제공되며, <br />
          로그인 한 사용자의 경우 랭킹 시스템도 이용 가능합니다.
        </Description>
        ...
        <Details>
          ...
          <DetailItem>
            ...
            설계하고 구현하였습니다. <br />
            사용자들이 쉽게 퀴즈에 접근할 수 있도록 직관적이고 깔끔한 디자인을
            적용하였으며, 퀴즈 주제 선택 등 주요 기능을 명확하게 배치하여 편리한
            사용자 경험을 제공했습니다. 또한 상단에 베너를 크게 배치하여 다양한
